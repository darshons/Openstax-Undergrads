...
uploaded_json_template = client.files.upload(
    file=json_template_file_path,
    config=types.UploadFileConfig(
        display_name="script_gen_decision_points_separate", mime_type="application/json"
    ),
)
...
uploaded_json_linear_script = client.files.upload(
    file=json_linear_script_path,
    config=types.UploadFileConfig(
        display_name="linear_script_for_reference", mime_type="application/json"
    ),
)
...
response = client.models.generate_content(
    ...
    contents=[
        user_query,
        *uploaded_md_files,
        uploaded_json_template,
        uploaded_json_linear_script,
    ],
    config=config,
)
