...
# Moved to video_generator/interaction_guard.py so it's importable as a
# proper package module from production code (solo_clip_pipeline.py /
# instructor_api.py), not just from sibling scripts run directly out of this
# directory. Re-exported here for backwards compatibility with
# solo_clip_test.py / solo_clip_finding_words.py's existing imports.
from video_generator.interaction_guard import (  # noqa: F401
