...
uploaded_json_template = client.beta.files.upload(file=("script_gen_decision_points_separate", open(json_template_file_path, "rb"), "text/plain"))
...
uploaded_json_linear_script = client.beta.files.upload(file=("linear_script_for_reference", open(json_linear_script_path, "rb"), "text/plain"))
...
content.append({"type": "document", "source": {"type": "file", "file_id": uploaded_json_template.id}, "title": "JSON Script Template"})

content.append({"type": "document", "source": {"type": "file", "file_id": uploaded_json_linear_script.id}, "title": "JSON Linear Scenario Script"})
