...
// "Elena's Knee" (Anthony) scenario, full 16-scene / 4-decision-point version for Studio review (script/assets/video pages).
export const ANTHONY_FULL_SCRIPT_DATA: Script = {
  ...
  "scenes": [
    ...
    },
    {
      "scene_id": 6,
      "type": "consequence",
      "scene_summary": "Jordan moves straight to the physical exam without completing the symptom screen. During the exam, Nurse Reyes checks in and points out that a key piece of history, Elena's prior ACL injury, was never gathered.",
      "duration_seconds": 18,
      "character_actions": "Jordan stands beside the exam table, beginning to position to examine the knee. Nurse Reyes steps in from the left. Elena sits on the table, watching.",
      "initial_character_positions": [
        {
          "character_id": "player",
          "position": "Center of frame, standing beside exam table"
        },
        {
          "character_id": "elena",
      ...
      "audio": {
        "dialogue": [
          {
            "character_id": "instructor",
            "line": "Nurse Reyes says quietly: Before the exam, did you ask Elena about any past knee injuries or surgeries? That history can really change what we are looking for.",
            "character_position": "Far left of frame"
          },
          {
            "character_id": "player",
            "line": "Jordan pauses and turns to Elena: Actually, I do want to ask about that first. Have you had any injuries to this knee in the past?",
            "character_position": "Center of frame, turning toward Elena"
          }
        ],
        "sound_effects": "None",
    ...
    },
    {
      "scene_id": 7,
      "type": "consequence",
      "scene_summary": "Jordan asks only about Elena's ibuprofen use. Nurse Reyes steps in to note that medication safety is important but cannot stand in for a full symptom and history screen.",
      "duration_seconds": 18,
      "character_actions": "Jordan sits in the chair to Elena's left. Nurse Reyes steps into the frame from the left. Elena sits on the exam table, hands in her lap.",
      "initial_character_positions": [
        {
          "character_id": "player",
          "position": "Left side of frame, seated in chair"
      ...
      "audio": {
        "dialogue": [
          {
            "character_id": "instructor",
            "line": "Nurse Reyes says gently: Medication use is worth knowing, and we will come back to it. But right now we need a full picture of her symptoms and any past injuries before we move on.",
            "character_position": "Far left of frame"
          },
          {
            "character_id": "player",
            "line": "Jordan nods and refocuses toward Elena: Let me back up. Have you noticed any swelling, redness, or warmth in the knee? And has this knee ever been injured before?",
            "character_position": "Left side of frame, seated in chair"
          }
        ],
        "sound_effects": "None",
    ...
    },
    {
      "scene_id": 10,
      "type": "consequence",
      "scene_summary": "Jordan escalates to an urgent evaluation, citing possible joint infection. Nurse Reyes steps in to review the findings and clarifies that infection typically presents with redness, significant warmth, and fever, none of which Elena has.",
      "duration_seconds": 18,
      "character_actions": "Nurse Reyes enters from the left. Jordan stands near the exam table. Elena sits on the table, looking mildly startled.",
      "initial_character_positions": [
        {
          "character_id": "player",
      ...
      "audio": {
        "dialogue": [
          {
            "character_id": "instructor",
            "line": "Nurse Reyes says calmly: A joint infection is serious, but it usually shows up as a hot, red, very swollen joint, sometimes with a fever. What did you find with Elena?",
            "character_position": "Far left of frame"
          },
          {
            "character_id": "player",
            "line": "Jordan pauses and reconsiders: Mild swelling and crepitus, but no redness, no warmth, no fever. You are right, the routine channel is the better call here.",
            "character_position": "Left center of frame"
          }
        ],
        "sound_effects": "None",
    ...
    },
    {
      "scene_id": 11,
      "type": "consequence",
      "scene_summary": "Jordan tells Elena the exam looks normal. Nurse Reyes steps in to note that swelling, crepitus, and reduced range of motion are not normal findings and need to be documented and reported accurately.",
      "duration_seconds": 18,
      "character_actions": "Nurse Reyes enters from the left. Jordan stands near the exam table. Elena sits on the table, expression slightly confused.",
      "initial_character_positions": [
        {
          "character_id": "player",
          "position": "Left center of frame, standing beside exam table"
      ...
      "audio": {
        "dialogue": [
          {
            "character_id": "instructor",
            "line": "Nurse Reyes says evenly: Swelling, crepitus, and reduced range of motion are findings that need to be documented and reported. They are not normal for this patient's age and activity level.",
            "character_position": "Far left of frame"
          },
          {
            "character_id": "player",
            "line": "Jordan turns back toward the notepad: Understood. I'll document exactly what I found and make sure the provider sees it.",
            "character_position": "Left center of frame, turning slightly"
          }
        ],
        "sound_effects": "None",
        "ambience": "Quiet clinic room, faint low hum of building ventilation"
    ...
    },
    {
      "scene_id": 14,
      "type": "consequence",
      "scene_summary": "Jordan offers false reassurance without any real information. Elena looks relieved briefly but then uncertain. Nurse Reyes steps in and redirects Jordan to give Elena actual information within their scope so she can understand her condition.",
      "duration_seconds": 18,
      "character_actions": "Nurse Reyes steps forward slightly from the left doorway. Jordan stands beside the exam table. Elena sits on the table, expression shifting from brief relief to uncertainty.",
      "initial_character_positions": [
        {
          "character_id": "player",
          "position": "Left center of frame, beside exam table"
        },
        {
          "character_id": "elena",
          "position": "Right side of frame, seated on exam table"
        ...
        {
          "character_id": "instructor",
          "position": "Far left of frame, stepping slightly forward"
        }
      ],
      "audio": {
        "dialogue": [
          {
            "character_id": "instructor",
            "line": "Nurse Reyes says quietly to Jordan: Elena deserves real information so she can be part of her own care. Let's give her what we can explain clearly.",
            "character_position": "Far left of frame"
          },
          {
            "character_id": "player",
            "line": "Jordan turns back to Elena: I want to give you a better answer than that. Let me explain a little about what this diagnosis actually means.",
            "character_position": "Left center of frame, turning toward Elena"
          }
        ],
        "sound_effects": "None",
        "ambience": "Quiet clinic room, faint low hum of building ventilation"
    ...
    },
    {
      "scene_id": 15,
      "type": "consequence",
      "scene_summary": "Jordan deflects entirely, saying it is a question for the provider. Elena's expression falls. Nurse Reyes steps forward and notes that basic patient education and support are part of the nursing role, not just the provider's.",
      "duration_seconds": 18,
      "character_actions": "Nurse Reyes steps forward from the left doorway. Jordan stands beside the exam table. Elena sits on the table, looking deflated.",
      "initial_character_positions": [
        {
          "character_id": "player",
          "position": "Left center of frame, beside exam table"
        ...
        {
          "character_id": "instructor",
          "position": "Far left of frame, stepping forward"
        }
      ],
      "audio": {
        "dialogue": [
          {
            "character_id": "instructor",
            "line": "Nurse Reyes says evenly: The provider will go into detail, but we can offer basic information and support right now. That is part of our role too.",
            "character_position": "Far left of frame"
          },
          {
            "character_id": "player",
            "line": "Jordan refocuses toward Elena: You are right to have questions. Let me share what I can while we wait for the provider to come back in.",
            "character_position": "Left center of frame, turning toward Elena"
          }
        ],
        "sound_effects": "None",
  ...
  "decision_points": [
    ...
    {
      "decision_point_id": 2,
      "question_text": "Jordan has completed the PQRSTU pain assessment. What should Jordan ask about next before moving to the physical exam?",
      "associated_introduction_scene_id": 5,
      "choices": [
        {
          "choice_id": "A",
          "text": "Screen for the hallmark musculoskeletal symptoms such as swelling, redness, and warmth, and ask directly whether Elena has had any past injuries to this knee.",
          "is_correct": true,
          "misconception": null,
          "routes_to_scene": 8
        },
        {
          "choice_id": "B",
          "text": "Move straight to the physical exam, since the pain assessment already covered the important details.",
          "is_correct": false,
          "misconception": "Learners may assume that the PQRSTU assessment is sufficient on its own. Completing a full symptom screen and past injury history is still needed, as key risk factors like a prior ACL injury can be missed otherwise.",
          "routes_to_scene": 6
        },
        {
          "choice_id": "C",
          "text": "Focus the next questions entirely on Elena's ibuprofen use, since medication safety is the most pressing concern at this point.",
          "is_correct": false,
          "misconception": "Learners may prioritize medication safety, which is genuinely important, but isolating that single topic skips the full symptom screen and past injury history that are needed to build a complete clinical picture.",
          "routes_to_scene": 7
        }
      ]
    },
    {
      "decision_point_id": 3,
      "question_text": "Jordan has completed the physical exam and found mild swelling, crepitus, reduced range of motion, and mild quad weakness, with no redness, warmth, or fever. What should Jordan do with these findings?",
      "associated_introduction_scene_id": 9,
      "choices": [
        {
          "choice_id": "A",
          "text": "Document the objective findings clearly and prepare a concise report for the provider, noting what was present and confirming that there were no signs of infection or systemic inflammation.",
          "is_correct": true,
          "misconception": null,
          "routes_to_scene": 12
        },
        {
          "choice_id": "B",
          "text": "Escalate immediately for an urgent evaluation, since swelling and grinding in the joint could indicate a joint infection.",
          "is_correct": false,
          "misconception": "Learners may over-attribute swelling and crepitus to infection without checking for the hallmark signs. A joint infection typically presents with significant redness, heat, and often fever, none of which are present here.",
          "routes_to_scene": 10
        },
        {
          "choice_id": "C",
          "text": "Tell Elena that the exam looks normal and there is nothing to worry about, since the findings are not dramatic.",
          "is_correct": false,
          "misconception": "Learners may underestimate findings that are not severe or visually obvious. Swelling, crepitus, reduced range of motion, and asymmetric strength are all clinically significant and must be documented and reported accurately.",
          "routes_to_scene": 11
        }
      ]
    },
    {
      "decision_point_id": 4,
      "question_text": "Elena has just been told her diagnosis and is asking Jordan directly whether she will need surgery and whether she has to give up soccer. How should Jordan respond?",
      "associated_introduction_scene_id": 13,
      "choices": [
        {
          "choice_id": "A",
          "text": "Explain in plain language what osteoarthritis means, let Elena know that most cases are managed with conservative steps first, and be honest that surgery is usually considered only if those steps are not enough.",
          "is_correct": true,
          "misconception": null,
          "routes_to_scene": 16
        },
        {
          "choice_id": "B",
          "text": "Tell Elena not to worry and that she will be totally fine, without offering any further explanation.",
          "is_correct": false,
          "misconception": "Learners may think reassurance is more supportive than explanation. False reassurance without real information does not help the patient understand her condition or prepare for what comes next, and may increase anxiety later.",
          "routes_to_scene": 14
        },
        {
          "choice_id": "C",
          "text": "Tell Elena those questions are for the provider and change the subject to avoid overstepping.",
          "is_correct": false,
          "misconception": "Learners may believe that any patient education belongs solely to the provider. Offering basic plain-language explanation and emotional support in this moment is within the nursing role and is an important part of therapeutic communication.",
          "routes_to_scene": 15
        }
      ]
    }
